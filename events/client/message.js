...
module.exports = (client, message) => {
    ...
    if (command.help.hasChannel && !command.help.hasChannel.some((id) => message.channel.id == (id))) return message.reply("Tu n'est pas dans un salon autorisé pour utiliser cette commande!");
